#ifndef KERNELLIB_KERNELS_MATERNFIVETWO_HPP
#define KERNELLIB_KERNELS_MATERNFIVETWO_HPP
...
namespace kernel_lib {
    ...
    namespace kernels {
        ...
        class MaternFiveTwo : public AbstractKernel2<Params> {
        public:
            MaternFiveTwo()
            {
...
#endif // KERNELLIB_KERNELS_MATERNFIVETWO_HPP