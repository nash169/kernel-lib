...
namespace kernel_lib {
    ...
    namespace kernels {
        ...
        public:
            ...
            std::unique_ptr<Eigen::MatrixXd> logKernel(const Eigen::MatrixXd& x, const Eigen::MatrixXd& y) const
            {
...
#pragma omp parallel for collapse(2)
                ...
                return std::make_unique<Eigen::MatrixXd>(k);
            }
        ...
        protected:
            ...
            Eigen::MatrixXd kernel(const Eigen::MatrixXd& x, const Eigen::MatrixXd& y) const override
            {
                ...
                std::unique_ptr<Eigen::MatrixXd> k = logKernel(x, y);
